...
ARGV.each do | movie |
  ...
  edl.each_with_index do |val, index|
 ...
 -f segment -segment_list /dev/null -segment_times #{ffcutpoints} -segment_time_delta 0.05 -bsf:v h264_mp4toannexb #{directory2}/#{moviename}.%03d.ts"
  ...
  # Add concatlist to tempfiles array
